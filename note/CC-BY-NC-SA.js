...
标志	权利	备注
Attribution	署名（英语：Attribution，by）	您（用户）可以复制、发行、展览、表演、放映、广播或通过信息网络传播本作品；您必须按照作者或者许可人指定的方式对作品进行署名。
Share-alike	相同方式共享（英语：ShareAlike，sa）	您可以自由复制、散布、展示及演出本作品；若您改变、转变或更改本作品，仅在遵守与本作品相同的许可条款下，您才能散布由本作品产生的派生作品。（参见copyleft。）
Non-commercial	非商业性使用（英语：Noncommercial，nc）	您可以自由复制、散布、展示及演出本作品；您不得为商业目的而使用本作品。
Non-derivative	禁止演绎（英语：No Derivative Works，nd)	您可以自由复制、散布、展示及演出本作品；您不得改变、转变或更改本作品。
组合
...
许可协议	简称	图标	自由版权
创作共用-署名	CC-BY	Cc.logo.circle.svg Cc-by new.svg	是
创作共用-署名-相同方式共享	CC-BY-SA	Cc.logo.circle.svg Cc-by new.svg Cc-sa.svg	是
创作共用-署名-非商业性	CC-BY-NC	Cc.logo.circle.svg Cc-by new.svg Cc-nc.svg	否
创作共用-署名-禁止演绎	CC-BY-ND	Cc.logo.circle.svg Cc-by new.svg Cc-nd.svg	否
创作共用-署名-非商业性-禁止演绎	CC-BY-NC-ND	Cc.logo.circle.svg Cc-by new.svg Cc-nc.svg Cc-nd.svg	否
创作共用-署名-非商业性-相同方式共享	CC-BY-NC-SA	Cc.logo.circle.svg Cc-by new.svg Cc-nc.svg Cc-sa.svg	否
创作共用-相同方式共享	CC-SA	Cc.logo.circle.svg Cc-sa.svg	是
创作共用-非商业性	CC-NC	Cc.logo.circle.svg Cc-nc.svg	否
创作共用-禁止演绎	CC-ND	Cc.logo.circle.svg Cc-nd.svg	否
创作共用-非商业性-相同方式共享	CC-NC-SA	Cc.logo.circle.svg Cc-nc.svg Cc-sa.svg	否
创作共用-非商业性-禁止演绎	CC-NC-ND	Cc.logo.circle.svg Cc-nc.svg Cc-nd.svg	否
